...
import com.tesda.service.TdgDataConditionService;
			...
			if (tdgDataConditionDTO != null) {
				if (tdgDataConditionDTO.getId() != 0) {
					Map<String, List<String>> mapResult = tdgOperationsService
							.retrieveManualDictionaryValues(tdgDataConditionDTO.getTablename(),null);
					...
					if (iMaxSize == 0) {
						...
						Set<String> lstTabs = new HashSet<String>();
