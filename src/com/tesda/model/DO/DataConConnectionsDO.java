...
@NamedQueries({
		...
		@NamedQuery(name = "DataConConnectionsDO.findByDisplayName", query = "SELECT t FROM DataConConnectionsDO t WHERE t.displayName = :displayName"),
		@NamedQuery(name = "DataConConnectionsDO.findByConnectionId", query = "SELECT t FROM DataConConnectionsDO t WHERE t.dataConConnId = :dataConConnId"),
