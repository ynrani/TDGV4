...
@NamedQueries({
		@NamedQuery(name = "TdgSchemaDO.findAll", query = "SELECT t FROM TdgSchemaDO t ORDER BY t.reqschemaid DESC"),
		...
		@NamedQuery(name = "TdgSchemaDO.findByConnectionName", query = "SELECT t FROM TdgSchemaDO t WHERE t.dataconnections =:dataconnections"),
		...
		@NamedQuery(name = "TdgSchemaDO.findTotalDictionaries", query = "SELECT COUNT(t) FROM TdgSchemaDO t "),
		@NamedQuery(name = "TdgSchemaDO.findTotalManualDict", query = "SELECT COUNT(t) FROM TdgSchemaDO t WHERE t.manualdictionary IS NOT NULL")})
