...
@NamedQueries({
		...
		@NamedQuery(name = "TdgRequestListDO.findTotalRequests", query = "SELECT COUNT(r) FROM TdgRequestListDO r"),
		@NamedQuery(name = "TdgRequestListDO.findSucess", query = "SELECT COUNT(r) FROM TdgRequestListDO r WHERE r.status='Success'"),
		@NamedQuery(name = "TdgRequestListDO.findFailed", query = "SELECT COUNT(r) FROM TdgRequestListDO r WHERE r.status='Failed'"),
