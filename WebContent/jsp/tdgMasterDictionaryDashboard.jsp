...
<body>
 ...
 <form:form name="masterDictionary"
								...
								<thead>
									<tr>
										...
										<th align="center" bgcolor="#E3EFFB" scope="col"
											...
											<th align="center" bgcolor="#E3EFFB" scope="col"
											class="whitefont">DB Connection Name</th>
										<th align="center" bgcolor="#E3EFFB" scope="col"
											class="whitefont">Url</th>
										<th align="center" bgcolor="#E3EFFB" scope="col"
											class="whitefont">Schema Name</th>
										<th align="center" bgcolor="#E3EFFB" scope="col"
											class="whitefont">Master Dictionary</th>
											<th align="center" bgcolor="#E3EFFB" scope="col"
										...
										<th align="center" bgcolor="#E3EFFB" scope="col"
											...
											<th align="center" bgcolor="#E3EFFB" scope="col"
											class="whitefont">Download MasterDictionary</th>
											<th align="center" bgcolor="#E3EFFB" scope="col"
											class="whitefont">Edit Dictionary</th> -->
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${tdgSchemaDTOList}" var="tdgSchemaDTOList"
										...
										<tr>
											...
											<td align="left">${tdgSchemaDTOList.dataconnections}</td>
											<td align="left">${tdgSchemaDTOList.url}</td>
											<td align="left">${tdgSchemaDTOList.schemaname}</td>
											<td align="left">
												<a href="#" onClick="editTdgReqDictionary('${tdgSchemaDTOList.reqschemaid}')">Edit</a> or 
												<a href="#" onClick="deleteTdgReqDictionary('${tdgSchemaDTOList.reqschemaid}','')">Delete</a> or
												<a href="#" onClick="downloadTdgReqDictionary('${tdgSchemaDTOList.reqschemaid}')">Download</a>
											</td>
											<td>
											<c:choose>
												<c:when test="${tdgSchemaDTOList.manualdictionary != null && tdgSchemaDTOList.manualdictionary != ''}">
													<a href="#" onClick="deleteTdgReqDictionary('${tdgSchemaDTOList.reqschemaid}','${tdgSchemaDTOList.manualdictionary}')">Detach</a> (${tdgSchemaDTOList.manualdictionary})
												</c:when>
												<c:otherwise>
													<a href="javascript:;" onclick="popup('./uploadManualDictionary?reqSchemaId=${tdgSchemaDTOList.reqschemaid}','Upload Manual Dictionary','popup','popupOverlay','500');" title="click here to upload manual dictionary">Attach</a>
												</c:otherwise>
											</c:choose>
										</tr>
									</c:forEach>
  ...
  function downloadTdgReqDictionary(reqId){
		// if (confirm('Are you sure to delete the dictionary?')) {
	 	   document.location.href="./downloadTdgMasterDictionaryByReqSchemaId?reqSchemaId="+reqId;
		  //}
}
  function editTdgReqDictionary(reqId){
		// if (confirm('Are you sure to delete the dictionary?')) {
	 	   document.location.href="./editTdgMasterDictionary?reqSchemaId="+reqId;
		  //}
}  
