					...
					<ul>
						<li id="admin"><a href="#" >Admin</a>
							<ul>
								...
								<li><a href="admin_cfg_mgmt" >Application Configuration Management</a>
								<ul>
						...
						<li id="services"><a href="#" >Services</a>
							<ul>
								...
								<li id="services_ftd"><a href="./testdaUser">Find Test Data</a></li>
								<li id="services_tdg"><a href="#">TDG</a></li>
