...
<title>TDG | Add Table Alias</title>
...
<body>
	...
	<div class="mainAll">
		...
		<section class="bodySec">
			<div class="container">
			  <form:form id="tdmUploadForm" name="tdmUploadForm" action="${pageContext.request.servletContext.contextPath}/createalias" modelAttribute="tdgTableAliasDTO">
          	 	<div class="two-col">
          	 	<h2 style="color: #0098cc ;   padding-top: 5%;">Add Table Alias</h2>
