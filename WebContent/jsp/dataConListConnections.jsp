...
<title>TDG Connections Dashboard</title>
			 ...
			 <tbody>
                 <c:forEach items="${dbConnectionsDTOs}" var="dbConnectionsDTOs" varStatus="status">
                   <tr onmouseover="this.style.cursor='pointer'" onClick="getRequestDtls('${dbConnectionsDTOs.conId}')">
                     ...
                     <td align="left">${dbConnectionsDTOs.displayName}</td>
                     ...
                     <td align="left">${dbConnectionsDTOs.active}</td>
											<c:choose>
												<c:when
													test="${fn:containsIgnoreCase(dbConnectionsDTOs.displayName, 'TDG')}">
                     <td align="left"></td>
												</c:when>
												<c:otherwise>
												<c:choose>
													<c:when
														test="${fn:contains(dbConnectionsDTOs.displayName, 'EXIST')}">
														<td align="left"></td>
													</c:when>
													<c:otherwise>
														<td align="left"><a
															href="./dataConDeleteConnection?id=${dbConnectionsDTOs.conId}">Delete</a></td>
													</c:otherwise>
													</c:choose>
												</c:otherwise>
											</c:choose>
