...
map = new HashMap<Object,Object>(); map.put("y", 72.48);  map.put("legendText", "DB");  map.put("label", "DB"); list.add(map);
map = new HashMap<Object,Object>(); map.put("y", 10.39);  map.put("legendText", "XLS");  map.put("label", "XLS"); list.add(map);
map = new HashMap<Object,Object>(); map.put("y", 7.78);  map.put("legendText", "CSV");  map.put("label", "CSV"); list.add(map);
map = new HashMap<Object,Object>(); map.put("y", 7.14);  map.put("legendText", "XLSFL");  map.put("label", "XLSFL"); list.add(map);
map = new HashMap<Object,Object>(); map.put("y", 0.22);  map.put("legendText", "CSVFL");  map.put("label", "CSVFL"); list.add(map);
map = new HashMap<Object,Object>(); map.put("y", 0.15);  map.put("legendText", "XML");  map.put("label", "XML"); list.add(map);		
